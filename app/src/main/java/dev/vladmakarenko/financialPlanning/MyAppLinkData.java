...
public class MyAppLinkData {
    ...
    private static final String TAG = MyAppLinkData.class.getCanonicalName();
    ...
    public static void fetchDeferredAppLinkData(
            Context context, NothingObserver observer, CompletionHandler completionHandler) {
        fetchDeferredAppLinkData(context, null, completionHandler, observer);
    }
     ...
     */
    public static void fetchDeferredAppLinkData(
            Context context, String applicationId, final CompletionHandler completionHandler, NothingObserver observer) {
                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                fetchDeferredAppLinkFromServer(
                                        applicationContext, applicationIdCopy, completionHandler, observer);
                            }
                        });
    }
    ...
    private static void fetchDeferredAppLinkFromServer(
        ...
        MyAppLinkData appLinkData = null;
    ...
    @Nullable
    public static MyAppLinkData createFromActivity(Activity activity) {
        ...
        MyAppLinkData appLinkData = createFromAlApplinkData(intent);
        if (appLinkData == null) {
    ...
    @AutoHandleExceptions
    @Nullable
    public static MyAppLinkData createFromAlApplinkData(Intent intent) {
        if (intent == null) {
            return null;
        }
        ...
        MyAppLinkData appLinkData = new MyAppLinkData();
    ...
    @Nullable
    private static MyAppLinkData createFromJson(String jsonString) {
        if (jsonString == null) {
            return null;
        }
    ...
    @Nullable
    private static MyAppLinkData createFromUri(Uri appLinkDataUri) {
    ...
    public interface CompletionHandler {
         ...
         */
        void onDeferredAppLinkDataFetched(@Nullable MyAppLinkData appLinkData);
    }
}
